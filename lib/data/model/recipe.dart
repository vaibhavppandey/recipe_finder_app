class Recipe {
  ...
  factory Recipe.fromJson(Map<String, dynamic> json) {
    ...
    return Recipe(
      id: s('idMeal'),
      meal: s('strMeal'),
      mealAlternate: s('strMealAlternate'),
      category: s('strCategory'),
      area: s('strArea'),
      instructions: s('strInstructions'),
      mealThumb: s('strMealThumb'),
      tags: s('strTags'),
      youtube: s('strYoutube'),
      source: s('strSource'),
      imageSource: s('strImageSource'),
      creativeCommonsConfirmed: s('strCreativeCommonsConfirmed'),
      dateModified: s('dateModified'),
      ingredient1: s('strIngredient1'),
      ingredient2: s('strIngredient2'),
      ingredient3: s('strIngredient3'),
      ingredient4: s('strIngredient4'),
      ingredient5: s('strIngredient5'),
      ingredient6: s('strIngredient6'),
      ingredient7: s('strIngredient7'),
      ingredient8: s('strIngredient8'),
      ingredient9: s('strIngredient9'),
      ingredient10: s('strIngredient10'),
      ingredient11: s('strIngredient11'),
      ingredient12: s('strIngredient12'),
      ingredient13: s('strIngredient13'),
      ingredient14: s('strIngredient14'),
      ingredient15: s('strIngredient15'),
      ingredient16: s('strIngredient16'),
      ingredient17: s('strIngredient17'),
      ingredient18: s('strIngredient18'),
      ingredient19: s('strIngredient19'),
      ingredient20: s('strIngredient20'),
      measure1: s('strMeasure1'),
      measure2: s('strMeasure2'),
      measure3: s('strMeasure3'),
      measure4: s('strMeasure4'),
      measure5: s('strMeasure5'),
      measure6: s('strMeasure6'),
      measure7: s('strMeasure7'),
      measure8: s('strMeasure8'),
      measure9: s('strMeasure9'),
      measure10: s('strMeasure10'),
      measure11: s('strMeasure11'),
      measure12: s('strMeasure12'),
      measure13: s('strMeasure13'),
      measure14: s('strMeasure14'),
      measure15: s('strMeasure15'),
      measure16: s('strMeasure16'),
      measure17: s('strMeasure17'),
      measure18: s('strMeasure18'),
      measure19: s('strMeasure19'),
      measure20: s('strMeasure20'),
    );
  }
